...
---------|--------|---|----|----|----|---|--------------
*specification_level* | list | O | F | F | F | O | The stack up of this board. Possible values are (string): "free" (The manufacturer can choose the stackup that matches the rest of the requirements), "separate_file" (A file is supplied with the package that will contain the actual stackup.), "specified" (The actual stackup is under the stackup->specified tag)
...
*external_base_copper_thickness* | list | O | F | F | O | O | Finished base copper thickness following IPC Class on the up to two external layers in micrometer.. Possible values are (float): "5.1", "8.5", "12", "17.1", "25.7", "34.3", "68.6", "102.9", "137.2", "171.5", "205.7", "240", "342.9", "480.1"
*internal_base_copper_thickness* | list | O | F | F | O | O | Finished base copper thickness following IPC Class on the internal layers in micrometer.. Possible values are (float): "5.1", "8.5", "12", "17.1", "25.7", "34.3", "68.6", "102.9", "137.2", "171.5", "205.7", "240", "342.9", "480.1"
*copper_foil_roughness* | list | O | O | O | O | O | The roughness of the copper foil.. Possible values are (string): "S" (Standard profile), "L" (Low profile), "V" (Very low profile)
...
*internal_base_copper_thickness* | list | O | F | F | O | O | Finished base copper thickness following IPC Class on the internal layers in micrometer.. Possible values are (float): "5.1", "8.5", "12", "17.1", "25.7", "34.3", "68.6", "102.9", "137.2", "171.5", "205.7", "240", "342.9", "480.1"
*copper_foil_roughness* | list | O | O | O | O | O | The roughness of the copper foil.. Possible values are (string): "S" (Standard profile), "L" (Low profile), "V" (Very low profile)
*copper_foil_type* | list | O | O | O | O | O | The The type of the copper foil. Possible values are (string): "ED" (Electro Deposited), "RA" (Rolled Annealed Copper), "ED" (Default)
*copper_coverage_average* | float | O | F | F | F | O | The average copper coverage of the board. UoM is percentage
...
Data tag | Format | P | PD | PE | PR | C | Description
---------|--------|---|----|----|----|---|--------------
*finish* | list | O | O | O | O | O | The material/method/surface to be used in the finish.. Possible values are (string): "c_bare_copper" (AABUS), "isn" (IPC-4554 Immersion Tin), "iag" (IPC-4553 Immersion Silver), "enepig" (IPC-4552 Immersion Gold), "osp" (J-STD-003 Organic Solderability Preservative), "ht_osp" (J-STD-003 High Temperature OSP), "g" (ASTM-B-488 Gold for edge printed board connectors and areas not to be soldered), "GS" (J-STD-003 Gold Electroplate on areas to be soldered), "t_fused" (J-STD-003 Electrodeposited Tin-Lead (fused)), "tlu_unfused" (J-STD-003 Electrodeposited Tin-Lead Unfused), "dig" (J-STD-003 Direct Immersion Gold (Solderable Surface)), "gwb-1_ultrasonic" (ASTM-B-488 Gold Electroplate for areas to be wire bonded (ultrasonic)), "gwb-2-thermosonic" (ASTM-B-488 Gold Electroplate for areas to be wire bonded (thermosonic)), "s_hasl" (J-STD-003_J-STD-006 Solder Coating over Bare Copper (HASL)), "lf_hasl" (J-STD-003_J-STD-006 Lead-Free Solder Coating over Bare Copper (Lead-Free HASL, Lead free HASL))
...
*finish* | list | O | O | O | O | O | The finish of the soldermask.. Possible values are (string): "mate" (Finish), "semi-mate" (Finish), "glossy" (Finish), "any" (Finish)
...
*placement* | list | O | O | O | O | O | Indicating if the stiffener is on top or bottom of the flexible layer.. Possible values are (string): "top" (The stiffener is on top of the flexible layer(s)), "bottom" (The stiffener is below the flexible layer(s))
...
Data tag | Format | P | PD | PE | PR | C | Description
---------|--------|---|----|----|----|---|--------------
*type_of_bag* | list | O | O | O | O | O | The material of the bag to be used. Possible values are (string): "a" (Nylon/Foil/Polyethylene), "b" (TyvekTM/Foil/Polyethylene), "c" (Aluminized Polyester/Polyethylene), "d" (Plastics/Polymers (non-metallic))
...
*fiducials_shape* | list | O | O | O | O | O | The shape of the fiducials.. Possible values are (string): "donut", "circle", "plus", "diamond"
*breakaway_method* | list | O | O | O | O | O | The method of creation of the breakaways on the array. Possible values are (string): "routing", "routing" (alises includes "v-cut" and "v-grove"), "jump_scoring"
...
*placement* | list | O | O | O | O | O | Placement of the markings.. Possible values are (string): "copper_top", "copper_bottom", "soldermask_top", "soldermask_bottom", "legend_top", "legend_bottom"
...
*ul94* | list | O | O | O | O | O | Counterboring from the top present.. Possible values are (string): "v_0", "v_1", "v_2"
...
*ipc_6010_class* | list | O | O | O | O | O | According to Table 4-2 /4-3.. Possible values are (string): "1", "2", "3"
*ipc_6010_compliance_level* | list | O | O | O | O | O | . Possible values are (string): "full", "factory_standard", "aabus" (As Agreed Between User and Supplier)
*ipc_6010_copper_plating_thickness_level* | list | O | O | O | O | O | Used either if ipc_6010_class is set to 2 and you want to add copper plating thickness demands from class 3, or the other way round - class 3 is set but you can accept demands from class 2.. Possible values are (string): "2", "3"
*ipc_6010_annular_ring_level* | list | O | O | O | O | O | Used either if ipc_6010_class is set to 2 and you want to add annular ring demands from class 3, or the other way round - class 3 is set but you can accept demands from class 2.. Possible values are (string): "2", "3"
*ipc_6010_conductor_spacing_level* | list | O | O | O | O | O | Used either if ipc_6010_class is set to 2 and you want to add conductor spacing demands from class 3, or the other way round - class 3 is set but you can accept demands from class 2.. Possible values are (string): "2", "3"
*ipc_6010_conductor_width_level* | list | O | O | O | O | O | Used either if ipc_6010_class is set to 2 and you want to add conductor width demands from class 3, or the other way round - class 3 is set but you can accept demands from class 2.. Possible values are (string): "2", "3"
*ipc_6012_class* | list | O | O | O | O | O | Requirements according to IPC 6012 class.. Possible values are (string): "1", "2", "3", "3A" (Automotive addendum), "3S" (Space and Military Avionics Addendum), "3M" (Medical Addendum)
*ipc_6013_class* | list | O | O | O | O | O | Requirements according to IPC 6013 for flexible or rigid-flex boards.. Possible values are (string): "1", "2", "3"
...
*impedance* | list | O | O | O | O | O | . Possible values are (string): "controlled", "calculated", "follow_stackup"
...
*type* | list | O | F | F | F | O | The type of holes.. Possible values are (string): "through", "blind", "buried", "back_drill"
...
*method* | list | O | F | F | F | O | Can be either "routing" or "drilling", where drilling is default. Possible values are (string): "routing", "drilling", "laser"
