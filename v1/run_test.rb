...
puts circuitdata_checker( 'testfile-product.json' )

# Test the Stackup
puts "Test the Stackup"
puts circuitdata_checker( 'testfile-stackup.json' )

# Test the Profile defaults
puts "Test the Profile defaults"
puts circuitdata_checker( 'testfile-product.json', 'testfile-profile-default.json' )

# Test the Profile required
puts "Test the Profile enforced"
puts circuitdata_checker( 'testfile-product.json', 'testfile-profile-enforced.json' )

# Test the Profile restricted
puts "Test the Profile restricted"
puts circuitdata_checker( 'testfile-product.json', 'testfile-profile-restricted.json' )

# Test the Capabilities
puts "Test the Capabilities"
puts circuitdata_checker( 'testfile-product.json', 'testfile-capability.json' )
